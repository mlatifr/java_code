...
class _BerandaState extends State<Beranda> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: widgetTampilanMenu(),
        ),
      ),
    );
  }

  Widget SemuaMenuMakananMinuman() {
    return Padding(
  ...
  var tampilanMenu = 'semuaMenu';
  Widget widgetTampilanMenu() {
    setState(() {});
    if (tampilanMenu == 'semuaMenu') {
      return Column(
        mainAxisSize: MainAxisSize.max,
