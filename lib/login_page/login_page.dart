...
import 'package:java_code/loading_menemukan_lokasi/loading_menemukan_lokasi.dart';
                            ...
                            onPressed: () async {
                              ...
                              await googleSignIn.signIn().then((value) {
                                setState(() {
                                  ...
                                  print(
                                      'current user = ${userGoogle?.displayName}');
                                });
                              }).then((value) {
                                Navigator.push(
                                  context,
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (googleSignIn.currentUser != null) {
                              print(
                                  'logout ${googleSignIn.currentUser?.displayName}');
                              await googleSignIn.disconnect();
                            } else
                              print('current user kosong');
                          },
                          child: Row(
                            children: [
                              const SizedBox(
